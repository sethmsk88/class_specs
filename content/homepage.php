...
<?php
	...
	/************************************************&*****/
	function getClassSpecs($payPlan, &$conn, $LOGGED_IN) {
	...
	$sel_classSpec_ap_result = getClassSpecs('ap', $conn, $LOGGED_IN);
	$sel_classSpec_usps_result = getClassSpecs('usps', $conn, $LOGGED_IN);
	$sel_classSpec_exec_result = getClassSpecs('exec', $conn, $LOGGED_IN);
	$sel_classSpec_fac_result = getClassSpecs('fac', $conn, $LOGGED_IN);

	...
	<table class="table job-specs">
		<tbody>
			...
			<tr>
				...
				<td>
					<span id="jobTitle">
						<?php echo $classSpec_row['JobTitle']; ?>
					</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					<label for="">Recommended Job Code Pay Range (from pay levels table):</label>
				</td>
				<td>
					<span id="recPayRange">
						<?php
			...
			<tr>
				<td>
					<label for="">Paygrade Range (from TMS):</label>
				</td>
				<td>
			...
			<tr>
				<td>
					<label for="">Approximate Number of People in Classification:</label>
				</td>
				<td>
					<span id="numEmps">
			...
			<tr>
				<td>
					<label for="">EEO Code:</label>
				</td>
				<td>
					<span id="eeoCode">
						<?php echo $classSpec_row['EEO_Code']; ?>
					</span>
				</td>
			</tr>
			<tr>
				<td>
					<label for="">IPEDS Code:</label>
				</td>
				<td>
					<span id="ipedsCode">
			...
			<tr>
				<td>
					<label for="">This position is FLSA:</label>
				</td>
				<td>
					<span id="flsa">
						<?php
			...
			<tr>
				<td>
					<label for="">CBU Code:</label>
				</td>
				<td>
					<span id="cbuCode">
						<?php echo $classSpec_row['CBU_Code']; ?>
					</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					<label for="">Recommended Competencies:</label>
				</td>
				<td>
				</td>
			</tr>
			...
			<tr>
				<td>
					<label for="">Police Background Check:</label>
				</td>
				<td>
					<span id="backgroundCheck">
						<?php
							if ($classSpec_row['BackgroundCheck'])
								echo 'Yes';
							else
			...
			<tr>
				<td>
					<label for="">Financial Disclosure:</label>
				</td>
				<td>
					<span id="financialDisclosure">
						<?php
							if ($classSpec_row['FinancialDisclosure'])
								echo 'Yes';
							else
			...
			<tr>
				<td>
					<label for="">Pre/Post Offer Physical:</label>
				</td>
				<td>
					<span id="physical">
						<?php
			...
			<tr>
				<td>
					<label for="">Confidentiality Statement:</label>
				</td>
				<td>
					<span id="confidentialityStmt">
						<?php
							if ($classSpec_row['ConfidentialityStmt'])
								echo 'Yes';
							else
			...
			<tr>
				<td>
					<label for="">Child Care Security Check:</label>
				</td>
				<td>
					<span id="childCareSecurityCheck">
						<?php
							if ($classSpec_row['ChildCareSecurityCheck'])
								echo 'Yes';
							else
